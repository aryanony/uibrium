...
import { Search, Mail, Lock, User, Bell, Info, CheckCircle2, Heart, Shield, Zap, Layers } from 'lucide-react';

export default function ComponentsPage() {
  return (
    <div className="space-y-24 pb-32">
      <header className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight lg:text-6xl italic">Sanctuary Primitives</h1>
        <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed font-light">
          A collection of deterministic logic gates architected for the modern web. Every component represents the equilibrium between performance and beauty.
        </p>
      </header>
      ...
      <section id="button" className="scroll-mt-24 space-y-8">
        <div className="space-y-3">
          <Badge variant="subtle" className="uppercase tracking-widest font-black text-[10px]">Foundation</Badge>
          ...
          <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-2xl">
            The fundamental interactive sanctuary primitive. Engineered for tactile resonance and deterministic action triggering.
          </p>
        </div>
...
<div className="flex items-center gap-4">
  ...
  <Button variant="soft">Sanctuary Soft</Button>
      ...
      <section id="accordion" className="scroll-mt-24 space-y-8">
        <div className="space-y-3">
          <Badge variant="subtle" className="uppercase tracking-widest font-black text-[10px]">Layout Logic</Badge>
          <h2 className="text-4xl font-bold tracking-tight">Accordion</h2>
          <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-2xl">
            A vertically stacked set of interactive headings that each reveal a sanctuary of content.
          </p>
        </div>
  ...
  <AccordionItem value="philosophy">
    ...
    <AccordionContent>
          ...
          <Accordion type="single" collapsible className="w-full max-w-lg">
            <AccordionItem value="logic">
              ...
              <AccordionContent className="text-muted-foreground font-light leading-relaxed">
                UiBrium is architected on the principle of Deterministic Integrity. We believe that every pixel should serve a purpose, and every interaction should evoke emotional resonance.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="craft">
              <AccordionTrigger className="text-lg font-bold">Handcrafted Perfection</AccordionTrigger>
              <AccordionContent className="text-muted-foreground font-light leading-relaxed">
                Each primitive is polished to a mirror finish, ensuring that your applications don't just work—they inspire.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </ComponentPreview>
      ...
      <section id="avatar" className="scroll-mt-24 space-y-8">
        <div className="space-y-3">
          <Badge variant="subtle" className="uppercase tracking-widest font-black text-[10px]">Identity</Badge>
          <h2 className="text-4xl font-bold tracking-tight">Avatar</h2>
          <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-2xl">
            Representational artifacts for identities within the sanctuary. Supports groups and fallbacks.
          </p>
        </div>
...
<AvatarGroup max={3}>
  <Avatar src="/user1.jpg" fallback="Aryan Gupta" />
  ...
  <Avatar fallback="Logic Engine" color="secondary" />
        ...
        >
          <div className="flex flex-col gap-8">
            <div className="flex items-center gap-6">
              <Avatar fallback="Aryan Gupta" size="xl" className="shadow-lg" />
      ...
      <section id="dialog" className="scroll-mt-24 space-y-8">
        <div className="space-y-3">
          <Badge variant="subtle" className="uppercase tracking-widest font-black text-[10px]">Overlays</Badge>
          <h2 className="text-4xl font-bold tracking-tight">Dialog (Modal)</h2>
          <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-2xl">
            A window overlaid on the primary sanctuary, requiring user attention to maintain logic flow.
          </p>
        </div>
  ...
  <DialogContent>
    ...
    {/* Content... */}
        ...
        >
          <Dialog>
            <DialogTrigger asChild>
              <Button size="lg" className="rounded-full shadow-2xl shadow-primary/20">Initialize Protocol</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px] rounded-[2rem] border-primary/20 bg-card/80 backdrop-blur-3xl">
              <DialogHeader className="space-y-4">
                ...
                <DialogTitle className="text-3xl font-black tracking-tight">Protocol Authorization</DialogTitle>
                <DialogDescription className="text-lg font-light italic">
                  You are entering the core logic engine. Please confirm your commitment to deterministic excellence.
                </DialogDescription>
              </DialogHeader>
              <div className="py-8 border-y border-border/50 my-6">
                 <p className="text-sm text-muted-foreground leading-relaxed">
                   Accessing the sanctuary requires a high level of aesthetic alignment. By proceeding, you agree to build with soul.
                 </p>
              </div>
              <DialogFooter>
                <DialogClose asChild>
                  <Button variant="ghost" className="rounded-full">Retreat</Button>
                </DialogClose>
      ...
      <section id="forms" className="scroll-mt-24 space-y-12">
        <div className="space-y-3">
          <Badge variant="subtle" className="uppercase tracking-widest font-black text-[10px]">Data Entry</Badge>
          <h2 className="text-4xl font-bold tracking-tight">Form Primitives</h2>
          <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-2xl">
            A suite of input gates for harvesting user intent while maintaining architectural symmetry.
          </p>
        </div>
           ...
           <Card className="rounded-[2.5rem] border-border/40 p-10 space-y-8 bg-muted/20">
              ...
              <div className="flex items-center justify-between p-4 rounded-2xl bg-background/50 border border-border/50">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground font-light">Enable micro-animations globally.</p>
                </div>
      ...
      <section id="table" className="scroll-mt-24 space-y-8">
        <div className="space-y-3">
           <Badge variant="subtle" className="uppercase tracking-widest font-black text-[10px]">Data Grid</Badge>
  ...
  <TableBody>
    <TableRow>
          ...
          <div className="w-full border rounded-[2rem] overflow-hidden bg-card/30 backdrop-blur-xl">
            <Table>
              <TableHeader className="bg-muted/50">
                <TableRow>
                  <TableHead className="font-black uppercase tracking-widest text-[10px]">Architectural Primitives</TableHead>
                  <TableHead className="font-black uppercase tracking-widest text-[10px]">Sanctuary Status</TableHead>
                  <TableHead className="text-right font-black uppercase tracking-widest text-[10px]">Deterministic Yield</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow className="hover:bg-primary/5 transition-colors">
                  <TableCell className="font-bold py-6">Modular Buttons</TableCell>
                  <TableCell><Badge variant="subtle" color="success">Calibrated</Badge></TableCell>
                  <TableCell className="text-right font-mono text-primary font-bold">100.0%</TableCell>
                </TableRow>
                <TableRow className="hover:bg-primary/5 transition-colors">
                  <TableCell className="font-bold py-6">Emotional Overlays</TableCell>
                  <TableCell><Badge variant="subtle" color="warning">Harmonizing</Badge></TableCell>
                  <TableCell className="text-right font-mono text-primary font-bold">98.4%</TableCell>
                </TableRow>
                <TableRow className="hover:bg-primary/5 transition-colors">
                  <TableCell className="font-bold py-6">Logic Gates (Forms)</TableCell>
                  <TableCell><Badge variant="subtle" color="primary">Optimized</Badge></TableCell>
                  <TableCell className="text-right font-mono text-primary font-bold">99.7%</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
      ...
      <Callout title="Legacy Verification" type="success">
        The documentation sanctuary is now fully synchronized with the core UI engine. Every primitive listed is production-ready and architecturally stable.
      </Callout>
    </div>
  );
}
