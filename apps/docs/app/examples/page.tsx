...
import { Badge, Button, Card, CardHeader, CardTitle, CardDescription } from '@uibrium/ui';
import { cn } from '@uibrium/ui';
import { Box, Layout, Sparkles, ArrowRight } from 'lucide-react';
  ...
  const examples = [
    {
      ...
      description:
        'A comprehensive dashboard for modern SaaS applications with complex data visualizations and management interfaces.',
    ...
    },
    {
      ...
      description:
        'High-conversion landing pages architected with emotional resonance and deterministic visual hierarchy.',
    ...
    },
    {
      ...
      description:
        'Modular settings interfaces with advanced form handling and state synchronization logic.',
    ...
    <div className="pt-32 pb-40 px-6">
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        <div className="max-w-3xl space-y-6">
          <Badge
            variant="outline"
            className="rounded-full px-4 py-1 uppercase tracking-[0.2em] text-[10px] font-black border-primary/20 text-primary"
          >
          ...
          <p className="text-xl text-muted-foreground font-light leading-relaxed">
            Discover how to bridge the delta between vision and implementation using the UiBrium
            design sanctuary. These examples represent the pinnacle of digital craftsmanship.
          </p>
        </div>
            ...
            >
              <Card className="h-full rounded-[2.5rem] border bg-card/30 backdrop-blur-xl group hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 overflow-hidden">
                ...
                <div className="px-10 pb-10">
                  <Button
                    variant="ghost"
                    className="p-0 text-primary font-bold uppercase tracking-widest text-xs group/btn"
                  >
                    Explore Blueprint{' '}
        ...
        <section className="rounded-[4rem] bg-muted/30 border border-border p-12 lg:p-24 relative overflow-hidden text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground font-light max-w-2xl mx-auto">
            The UiBrium ecosystem is built by the community. Contribute your blueprints and inspire
            the next generation of digital architects.
          </p>
