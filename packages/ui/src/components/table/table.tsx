...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement> & { sortable?: boolean; isSorted?: 'asc' | 'desc' | false }>(
      ...
      <div className="flex items-center gap-1.5">
        ...
        {sortable && (
          <div className="flex flex-col mt-[2px]">
            <svg
              className={cn("w-2 h-2 -mb-[2px]", isSorted === 'asc' ? 'text-primary' : 'text-muted-foreground/40')}
            ...
            <svg
              className={cn("w-2 h-2 mt-[2px]", isSorted === 'desc' ? 'text-primary' : 'text-muted-foreground/40')}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
