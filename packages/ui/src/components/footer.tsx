...
import { Github, Linkedin, Globe, ChevronRight, Heart } from 'lucide-react';
...
export function Footer({ className, logo }: FooterProps) {
  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        ...
        {
          name: 'Contribute',
          href: 'https://github.com/aryanony/uibrium/blob/main/CONTRIBUTING.md',
        },
  ...
  return (
    <footer
      className={cn(
        'relative z-10 border-t bg-background/50 backdrop-blur-3xl pt-24 pb-12',
        className,
      )}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-muted-foreground text-lg font-light leading-relaxed max-w-sm">
              Architecting the future of User Interfaces through technical determinism and emotional
              craft. A production-grade design sanctuary.
            </p>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <a
                  href="https://github.com/aryanony/uibrium.git"
                  target="_blank"
              ...
              >
                <a
                  href="https://linkedin.com/in/aryanony"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button
                ...
                variant="ghost"
                size="icon"
                className="rounded-full hover:bg-pink-500/10 hover:text-pink-500"
              >
                <a
                  href="https://aryanony.github.io/portfolio"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          {sections.map((section) => (
            <div key={section.title} className="space-y-6">
              <h4 className="text-sm font-black uppercase tracking-[0.25em] text-foreground/80">
                {section.title}
              </h4>
        ...
        <div className="pt-12 border-t flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col items-center md:items-start gap-2">
            <p className="text-muted-foreground text-sm font-light text-center md:text-left">
              &copy; {currentYear}{' '}
              <span className="text-foreground font-semibold">UiBrium Design Sanctuary</span>. All
              rights reserved.
            </p>
